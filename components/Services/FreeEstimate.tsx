...
export default function FreeEstimate({ subtitle, heading, locations, bottomHeading, bottomDescription }: FreeEstimateProps) {
  ...
  return (
    <section className="w-full relative pt-30 rounded-t-[4rem] mb-45"
      style={{
                ...
                {locations.map((loc, index) => (
                  <AnimateIn delay={0.1 * index}>
                    <button
                      ...
                      className={`px-6 py-2.5 rounded-full font-parkinsans font-regular text-sm  tracking-wider shadow-md transition-all duration-300 ${activeLocation === index
